...
const sections = ["Agro", "Autos", "Brasil", "Destaques", "Entretenimento", "Esportes", "Futebol", "Política", "Saúde", "Turismo"];
...
export function SiteShell({ children }: { children: ReactNode }) {
  ...
  return <div className="min-h-screen bg-background text-foreground">
    ...
    <div className="bg-primary py-3 text-primary-foreground"><div className="mx-auto flex max-w-7xl min-w-0 items-center gap-3 px-4 md:px-8"><span className="shrink-0 bg-destructive px-2 py-1 font-mono text-[10px] font-semibold uppercase">Plantão</span><p className="truncate text-sm italic">As principais notícias do Brasil e do mundo, atualizadas ao longo do dia.</p></div></div>
    {children}
